...
#401.bzip2
bzip22 = LiveProcess()
bzip22.executable =  binary_dir+'401.bzip22/exe/bzip2_base.gcc41-64bit'
data=data_dir+'401.bzip22/data/test/input/dryer.jpg'
bzip22.cmd = [bzip22.executable] + [data]
bzip22.output = 'drayer.jpg.out'
...
#445.gobmk
gobmk2=LiveProcess()
gobmk2.executable =  binary_dir+'445.gobmk2/exe/gobmk_base.gcc41-64bit'
stdin=data_dir+'445.gobmk2/data/test/input/capture.tst'
gobmk2.cmd = [gobmk2.executable]+['--quiet','--mode','gtp']
gobmk2.input=stdin
gobmk2.output='capture.out'
#====================
#447.dealII
dealII=LiveProcess()
...
#458.sjeng
sjeng2=LiveProcess()
sjeng2.executable =  binary_dir+'458.sjeng2/exe/sjeng_base.gcc41-64bit'
data=data_dir+'458.sjeng2/data/test/input/test.txt'
sjeng2.cmd = [sjeng2.executable]+[data]
sjeng2.output = 'test.out'
...
#462.libquantum
libquantum2=LiveProcess()
libquantum2.executable =  binary_dir+'462.libquantum2/exe/libquantum_base.gcc41-64bit'
libquantum2.cmd = [libquantum2.executable],'1397','8'
libquantum2.output = 'test.out'
...
#470.lbm
lbm2=LiveProcess()
lbm2.executable =  binary_dir+'470.lbm2/exe/lbm_base.gcc41-64bit'
data=data_dir+'470.lbm2/data/test/input/100_100_130_cf_a.of'
lbm2.cmd = [lbm2.executable]+['20', 'reference.dat', '0', '1' ,data]
lbm2.output = 'lbm.out'
#471.omnetpp
omnetpp=LiveProcess()
